...
cp -v qwertigraphy-clone/qwertigraph/pychorder/dictionaries/anniversary_uniform_core.csv anniversary-core/anniversary_uniform_core.csv
cp -v qwertigraphy-clone/qwertigraph/pychorder/dictionaries/anniversary_uniform_supplement.csv anniversary-supplement/anniversary_uniform_supplement.csv
